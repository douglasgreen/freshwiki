...
CREATE TABLE page_edit_log (
    ...
    page_id INT UNSIGNED NOT NULL,
    diff TEXT NOT NULL COMMENT 'Unified diff generated by jfcherng/php-diff',
    change_message VARCHAR(255) NULL COMMENT 'User-provided description of the change',
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    created_by INT UNSIGNED NULL,
...
COMMENT ON TABLE page_edit_log IS 'Diff-based edit history — stores changes against the live page version — OWNER: content-team';
COMMENT ON COLUMN page_edit_log.diff IS 'Unified diff format allowing reconstruction of historical page states';
